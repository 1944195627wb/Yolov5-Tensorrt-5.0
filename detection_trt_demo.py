...
class yolov5_tensorrt_demo(object):
    ...
    def detect(self, frame, if_view=False):
...
if __name__ == "__main__":
    ...
    yolov5 = yolov5_tensorrt_demo(PLUGIN_LIBRARY=ROOT / "tensorrt/build2/libmyplugins.so",
                                  engine_file_path=ROOT / "tensorrt/build2/yolov5s.engine",
                                  categories=categories)
    # 图片文件夹路径
    images_folder_path = ROOT / 'data/images'
    total_time = 0
    i=1
